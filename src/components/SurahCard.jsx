...
const SurahCard = ({ surah, onSelect }) => (
  <button
    className="w-full bg-white p-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] flex items-center text-left border 
    border-gray-100 focus:outline-none focus:ring-4 focus:ring-emerald-300"
